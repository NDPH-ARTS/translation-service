...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Bean
    public Docket api() {
        authorizationScopeList.add(new AuthorizationScope("api://translation-service-arts/read", "read privilege"));
        return new Docket(DocumentationType.SWAGGER_2).select().apis(
            RequestHandlerSelectors.basePackage("uk.ac.ox.ctsu.arts.translationservice.controller"))
